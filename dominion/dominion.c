//Kyle Wollman's refactored version of dominion.c
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerFunc(drawntreasure, currentPlayer, z, temphand, state);
      return 0;
			
    case council_room:
	  council_roomFunc(currentPlayer, state, handPos);	
	  return 0;
    ...
    case mine:
      mineFunc(state, currentPlayer, choice1, choice2, handPos);
